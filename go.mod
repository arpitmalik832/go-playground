...
require (
	github.com/conventionalcommit/commitlint v0.10.1 // Commit linting
	github.com/evilmartians/lefthook v1.10.10 // Git hooks
	github.com/golangci/golangci-lint v1.63.4 // Linting
	github.com/goreleaser/goreleaser v1.26.2 // Releases
	github.com/stretchr/testify v1.10.0 // For testing purposes
)
